...
TC1TD = halo_spatial[halo_spatial$`Geographic Address` == "M27/9415B",]
...
grid.arrange(DSL1, DSL2, DSL3, DSL4,DOL1, DOL2, DOL3, DOL4, DHL1, DHL2, DHL3, DHL4, nrow = 3, ncol = 4, top = "M27/9415B Downstream of Collision")

# Accident Profile M27/9416A - Severity 2 - Upstream

TC1TU = halo_spatial[halo_spatial$`Geographic Address` == "M27/9416A",]
...
grid.arrange(USL1, USL2, USL3, USL4,UOL1, UOL2, UOL3, UOL4, UHL1, UHL2, UHL3, UHL4, nrow = 3, ncol = 4, top = "M27/9416A Upstream of Collision")

# Accident Profile M27/9420B - Severity 2 - Rubbernecking

TC1TR = halo_spatial[halo_spatial$`Geographic Address` == "M27/9420B",]
...
grid.arrange(RSL1, RSL2, RSL3, RSL4,ROL1, ROL2, ROL3, ROL4, RHL1, RHL2, RHL3, RHL4, nrow = 3, ncol = 4, top = "M27/9420B 'Rubbernecking Effect' of Collision")
