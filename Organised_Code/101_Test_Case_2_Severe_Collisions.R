...
# Accident Profile M25/4633A - Severity 2 - Downstream

TC2TD = halo_spatial[halo_spatial$`Geographic Address` == "M25/4633A",]
...
grid.arrange(DSL1, DSL2, DSL3, DSL4,DOL1, DOL2, DOL3, DOL4, DHL1, DHL2, DHL3, DHL4, nrow = 3, ncol = 4, top = "M25/4633A Downstream of Collision")

# Accident Profile M25/4627A - Severity 2 - Upstream

TC2TU = halo_spatial[halo_spatial$`Geographic Address` == "M25/4627A",]
...
grid.arrange(USL1, USL2, USL3, USL4,UOL1, UOL2, UOL3, UOL4, UHL1, UHL2, UHL3, UHL4, nrow = 3, ncol = 4, top = "M25/4627A Upstream of Collision")

# Accident Profile M25/4633B - Severity 2 - Rubbernecking Upstream

TC2TRU = halo_spatial[halo_spatial$`Geographic Address` == "M25/4633B",]
...
grid.arrange(RSL1, RSL2, RSL3, RSL4,ROL1, ROL2, ROL3, ROL4, RHL1, RHL2, RHL3, RHL4, nrow = 3, ncol = 4, top = "M25/4633B 'Rubbernecking Effect' of Collision")
