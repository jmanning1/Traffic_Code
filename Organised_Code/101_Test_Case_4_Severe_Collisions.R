...
# Run 007_Formatting_Halogen_Data on 24/02/2016
...
# Accident Profile M6/5908A - Severity 2 - Downstream

TC1TD = halo_spatial[halo_spatial$`Geographic Address` == "M6/5908A",]
...
grid.arrange(DSL1, DSL2, DSL3, DSL4,DOL1, DOL2, DOL3, DOL4, DHL1, DHL2, DHL3, DHL4, nrow = 3, ncol = 4, top = "M6/5908A Downstream of Collision")

# Accident Profile M6/5903A - Severity 2 - Upstream

TC1TU = halo_spatial[halo_spatial$`Geographic Address` == "M6/5903A",]
...
grid.arrange(USL1, USL2, USL3, UOL1, UOL2, UOL3, UHL1, UHL2, UHL3, nrow = 3, ncol = 3, top = "M6/5903A Upstream of Collision")

# Accident Profile M6/5906B - Severity 2 - Rubbernecking

TC1TR = halo_spatial[halo_spatial$`Geographic Address` == "M6/5906B",]
...
grid.arrange(RSL1, RSL2, RSL3, RSL4,ROL1, ROL2, ROL3, ROL4, RHL1, RHL2, RHL3, RHL4, nrow = 3, ncol = 4, top = "M6/5906B 'Rubbernecking Effect' of Collision")

# Accident Profile M6/M6/5900B - Severity 2 - Rubbernecking Dowstream

TC1TR = halo_spatial[halo_spatial$`Geographic Address` == "M6/5900B",]
TC1buffer = st_buffer(TC1TR, 500)
TC1A = stat19_date[TC1buffer,]
...
grid.arrange(RSL1, RSL2, RSL3, RSL4,ROL1, ROL2, ROL3, ROL4, RHL1, RHL2, RHL3, RHL4, nrow = 3, ncol = 4, top = "M6/5900B 'Rubbernecking Effect' of Collision")
