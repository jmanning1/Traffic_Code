...
# Identification - This takes some time to run

# Identify Intervals - 3600 is the number of seconds in an hour.
...
# Output result as before and after assignment has long run times
