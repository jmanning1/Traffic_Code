...
cd "D:\Documents\5872M-Dissertation\Data\tcd"
...
bzip2-102-x86-win32.exe -d 10010518.tcd.bz2
...
TcdDecoder.exe D:\Documents\5872M-Dissertation\Data\tcd\*tcd --output-dir D:\Documents\5872M-Dissertation\Data\csv_files
